/********************金逸晨**************************
******************GMT114-02 模块 1.14"   8PIN SPI TFT FOR AT89S52/STC12*************
*****AT89S52驱动**************************
*********ST7789 控制器,
***** P30----3  SCL   ,  P31----4  SDA   ,  P32----5   RES
	  P33-----6   DC   , P34-----7 CS,      BLK可直接3V  ,  
***** BY:GU 
*********ST7789V2

从左往右，从上往下    135*240  18bit 6 6 6 RGB 模式  高位模式
...
#define SPI_SCL_0  P3 &=clr_0        //P3_0      
#define SPI_SCL_1  P3|=set_0       
#define SPI_SDA_0  P3&=clr_1        //P3_1        
#define SPI_SDA_1  P3|=set_1
#define SPI_RES_0  P3&=clr_2        //P3_2        
#define SPI_RES_1  P3|=set_2
