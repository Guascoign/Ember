...
#define CRC8Table CRC8_Table
#define CRC16Table CRC16_Modebus_Table
#define CRC32Table 

// CRC-8 多项式 X^8+X^2+X^1+1 生成的 CRC-8 表
...
// CRC-8 多项式 X^8+X^5+X^4+1 生成的 CRC-8-Maxim 表
...
// CRC-16 多项式 X^16+X^15+X^2+1 生成的 CRC-16-Modebus 表
static const uint16_t CRC16_Modebus_Table[256] =
    {
