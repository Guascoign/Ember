...
struct IIC_Device IIC1 = {
    .name = "MPU", // 设备名称
    .IIC_SCL_Port = IIC1_SCL_GPIO_Port, // SCL引脚所在的GPIO组
    .IIC_SCL_Pin = IIC1_SCL_Pin, // SCL引脚编号
    .IIC_SDA_Port = IIC1_SDA_GPIO_Port, // SDA引脚所在的GPIO组
    .IIC_SDA_Pin = IIC1_SDA_Pin, // SDA引脚编号
...
struct IIC_Device IIC2 = {
    .name = "EEPROM", // 设备名称
    .IIC_SCL_Port = IIC2_SCL_GPIO_Port, // SCL引脚所在的GPIO组
    .IIC_SCL_Pin = IIC2_SCL_Pin, // SCL引脚编号
    .IIC_SDA_Port = IIC2_SDA_GPIO_Port, // SDA引脚所在的GPIO组
    .IIC_SDA_Pin = IIC2_SDA_Pin, // SDA引脚编号
    .IIC_Init = iic_init, // 初始化IIC
    .IIC_Deint = iic_deinit, // 反初始化IIC
    .IIC_Start = iic_start, // 发送IIC开始信号
    .IIC_Restart = iic_restart, // 发送IIC重新开始信号
